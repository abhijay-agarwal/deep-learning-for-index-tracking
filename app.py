...
$ streamlit --version
    ...
    st.sidebar.markdown(
        "[Beta and experimental features](https://docs.streamlit.io/library/advanced-features/prerelease#beta-and-experimental-features)"
    )
    st.sidebar.code(
        """
...
pip install streamlit-nightly --upgrade
    ...
    st.sidebar.markdown(
        """<small>[st.cheat_sheet v1.8.0](https://github.com/daniellewisDL/streamlit-cheat-sheet)  | April 2022</small>""",
        unsafe_allow_html=True,
    )
